...
AppName=OptiFine 1.14.4_HD_U_F2(+QOL) Installer
AppVersion=0.7
;AppVerName=OptiFine Installer OptiFine_1.14.4_HD_U_F2
AppPublisher=anon
OutputBaseFilename=OptiFine_1.14.4_HD_U_F2_QOL_Inst
Compression=lzma
SolidCompression=yes
Uninstallable=no
VersionInfoTextVersion=OptiFine_1.14.4_HD_U_F2(+QOL)
...
begin
  Result:='OptiFine 1.14.4_HD_U_F2(+QOL) Installer'+#13#10;
  SMCDir:=MCDirCheck;
...
begin
  Result:=' -jar '+SOptiDir+'\'+'OptiFine_1.14.4_HD_U_F2.jar';
end;

[Files]
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: "OptiFine_1.14.4_HD_U_F2.jar"; DestDir: "{code:GetOutDir}"; Flags: ignoreversion
