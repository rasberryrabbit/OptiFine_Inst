...
AppName=OptiFine 1.14.3_HD_U_F1 Installer
AppVersion=0.1
;AppVerName=OptiFine Installer 1.14.3_HD_U_F1
AppPublisher=anon
OutputBaseFilename=OptiFine_1.14.3_HD_U_F1_Inst
Compression=lzma
SolidCompression=yes
Uninstallable=no
VersionInfoTextVersion=1.14.3_HD_U_F1
...
begin
  Result:='OptiFine 1.14.3_HD_U_F1 Installer'+#13#10;
  SMCDir:=MCDirCheck;
