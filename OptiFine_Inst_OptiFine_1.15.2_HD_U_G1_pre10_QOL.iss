...
Source: "Builder's QOL Shaders V2.4.1.zip"; DestDir: "{code:GetShaderDir}"; Flags: ignoreversion
Source: "Builder's Modded Shaders V2.4.1.zip"; DestDir: "{code:GetShaderDir}"; Flags: ignoreversion
Source: "UShader_v1.0.zip"; DestDir: "{code:GetShaderDir}"; Flags: ignoreversion
Source: "VPlus_v2.1.0.zip"; DestDir: "{code:GetShaderDir}"; Flags: ignoreversion
Source: "SEUS-Renewed-v1.0.1.zip"; DestDir: "{code:GetShaderDir}"; Flags: ignoreversion
Source: "naelegos-cel-shaders-1.0.4.zip"; DestDir: "{code:GetShaderDir}"; Flags: ignoreversion
