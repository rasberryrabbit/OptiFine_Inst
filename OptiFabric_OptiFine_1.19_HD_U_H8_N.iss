...
#define JarName1 'fabric-installer-0.11.0'
#define JarName2 'OptiFine_1.19_HD_U_H8'
#define JarName3 'optifabric-1.13.5'
#define JarName4 'fabric-api-0.57.0+1.19'
#define JarName5 'Xaeros_Minimap_22.11.1_Fabric_1.19'
#define JarName6 'voicechat-fabric-1.19-2.2.45'
#define JarName7 'CocoaInput-1.19-fabric-4.1.0-EXPERIMENTAL'
#define JarName8 'WindowedFullscreen-1.18-fabric-1.0.1'
#define JarName9 'sodium-fabric-mc1.19-0.4.2+build.16'
#define JarName10 'canvas-fabric-mc119-1.0.2410'
#define JarName11 'BetterF3-1.3.1-Fabric-1.19'
#define JarName12 'XaerosWorldMap_1.25.1_Fabric_1.19'
#define JarName13 'phosphor-fabric-mc1.19.x-0.8.1'
#define JarName14 'iris-mc1.19-1.2.5'
