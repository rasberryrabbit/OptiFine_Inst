...
AppName=forge-1.14.4-28.0.19-installer
AppVersion=0.7
;AppVerName={#SetupSetting("AppName")}
AppPublisher=anon
OutputBaseFilename={#SetupSetting("AppName")}
Compression=lzma
SolidCompression=yes
Uninstallable=no
VersionInfoTextVersion={#SetupSetting("AppName")}
...
begin
  Result:=' -jar '+SForgeDir+'\'+cAppName+'.jar';
end;

[Files]
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: "{#SetupSetting("AppName")}.jar"; DestDir: "{code:GetOutDir}"; Flags: ignoreversion
