...
AppName=OptiFine 1.14.4_HD_U_F2 Installer
AppVersion=0.7
;AppVerName=OptiFine Installer OptiFine_1.14.4_HD_U_F2
AppPublisher=anon
OutputBaseFilename=OptiFine_1.14.4_HD_U_F2_Inst
Compression=lzma
SolidCompression=yes
Uninstallable=no
VersionInfoTextVersion=OptiFine_1.14.4_HD_U_F2
...
begin
  Result:='OptiFine 1.14.4_HD_U_F2 Installer'+#13#10;
  SMCDir:=MCDirCheck;
