...
#define Enable_RENDER_SodiumExtra 0
...
; Fabric
#define JarFabricInstaller 'fabric-installer-1.1.2'
#define JarFabricAPI 'fabric-api-0.158.0+26.2'

; Map
#if Enable_MAP_Xaeros!=0
#define JarXaerosMinimap 'xaerominimap-fabric-26.2-26.4.2'
#define JarXaerosWorldmap 'xaeroworldmap-fabric-26.2-1.45.0'
#endif

#if Enable_MAP_journey!=0
#define JarJourneymap 'journeymap-fabric-26.2-6.0.5'
#endif
...
#define JarModMenu 'modmenu-20.0.1'
#endif

#if Enable_VOICE_chat!=0
#define JarVoicechat 'voicechat-fabric-1.21.11-2.6.10'
#endif
...
#define JarLithium 'lithium-fabric-0.25.3+mc26.2'
#endif
#define JarMoreculling 'moreculling-fabric-26.2-1.8.1'
...
#define JarSodium 'sodium-fabric-0.9.1+mc26.2'
#endif

; sodium extra
#if Enable_RENDER_SodiumExtra!=0
#define JarSodiumExtra 'sodium-extra-fabric-0.9.3+mc26.2'
#endif

#if Enable_RENDER_Iris!=0
#define JarIris 'iris-fabric-1.11.2+mc26.2'
#endif
...
#define JarLambDynamic 'lambdynamiclights-4.12.3+26.2'
#endif

#if Enable_AsyncParticle!=0
#define JarAsyncParticle 'AsyncParticles-26.1.0b-alpha.3+26.1.2'
#endif

#if Enable_SoundBeGone!=0
#define JarSoundBeGone 'soundsbegone-fabric-1.5.2+mc26.2'
...
#define ZipMellow 'Mellow Shader v3.3'
#endif
...
Name: "Shader\ZipMellow"; Description: "{#ZipMellow}"; Types: standard custom;
#endif
...
Source: "{#ZipMellow}.zip"; DestDir: "{code:GetShaderDir}"; Components: Shader\ZipMellow; Flags: ignoreversion
#endif
