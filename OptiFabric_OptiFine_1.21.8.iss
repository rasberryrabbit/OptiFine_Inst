...
#define JarFabricAPI 'fabric-api-0.133.4+1.21.8'

; Map
#if Enable_MAP_Xaeros!=0
#define JarXaerosMinimap 'Xaeros_Minimap_25.2.12_Fabric_1.21.8'
#define JarXaerosWorldmap 'XaerosWorldMap_1.39.13_Fabric_1.21.8'
#endif

#if Enable_MAP_journey!=0
#define JarJourneymap 'journeymap-fabric-1.21.8-6.0.0-beta.52'
#endif
...
#define JarModMenu 'modmenu-15.0.0'
#endif

#if Enable_VOICE_chat!=0
#define JarVoicechat 'voicechat-fabric-1.21.8-2.6.4'
#endif

#if Enable_IME_Chat!=0
; IME
;#define JarCaramelchat 'caramelChat-mc1.20.4-fabric-1.2.0'
#define JarKoreanIME 'koreanpatch-fabric-1.9.0+mc1.21.6'
#endif

; performance
#if Enable_PERF_Lithium!=0
#define JarLithium 'lithium-fabric-0.18.0+mc1.21.8'
#endif
...
#define JarSodium 'sodium-fabric-0.6.13+mc1.21.6'
#endif

#if Enable_RENDER_Iris!=0
#define JarIris 'iris-fabric-1.9.1+mc1.21.7'
#endif
