...
#define JarName "MineCraft Jar Installer Icon"
#define NewMCFolder "{pf32}\Minecraft Launcher\runtime\jre-x64\bin"
...
function GetJarFileName(dummy:string):string;
begin
  Result:=ExtractFileName(SJarFile);
  if Result='' then
    Result:='JarInstall';
end;
...
[Icons]
Name: "{autodesktop}\{code:GetJarFileName}"; Filename: "{code:JavaExec}"; Parameters: "{code:GetJarFile}";
