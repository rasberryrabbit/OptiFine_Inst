...
#define JarName4 'fabric-api-0.64.0+1.19.2'
#define JarName5 'Xaeros_Minimap_22.16.0_Fabric_1.19.1'
#define JarName6 'voicechat-fabric-1.19.2-2.3.11'
#define JarName7 'CocoaInput-1.19.2-fabric-4.1.2-EXPERIMENTAL'
#define JarName8 'WindowedFullscreen-1.18-fabric-1.0.1'
#define JarName9 'sodium-fabric-mc1.19.2-0.4.4+build.18'
#define JarName10 'canvas-fabric-mc119-1.0.2494'
#define JarName11 'BetterF3-4.0.0-Fabric-1.19.2'
#define JarName12 'XaerosWorldMap_1.28.1_Fabric_1.19.1'
