...
AppName=OptiFine 1.13.1_HD_U_E4 Installer
AppVersion=0.4
;AppVerName=OptiFine Installer 1.13.1_HD_U_E4
AppPublisher=anon
OutputBaseFilename=OptiFine_1.13.1_HD_U_E4_Inst
Compression=lzma
SolidCompression=yes
Uninstallable=no
VersionInfoTextVersion=1.13.1_HD_U_E4
...
begin
  Result:='OptiFine_1.13.1_HD_U_E4 Installer'+#13#10;
  SMCDir:=MCDirCheck;
...
begin
  Result:=' -jar '+SOptiDir+'\'+'OptiFine_1.13.1_HD_U_E4.jar';
end;

[Files]
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: "OptiFine_1.13.1_HD_U_E4.jar"; DestDir: "{code:GetOutDir}"; Flags: ignoreversion
