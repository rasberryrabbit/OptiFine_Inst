...
Uninstallable=no
VersionInfoTextVersion=1.14.3_HD_U_F1(+BSL)
...
begin
  Result:='OptiFine 1.14.3_HD_U_F1(+BSL) Installer'+#13#10;
  SMCDir:=MCDirCheck;
...
Source: "VPlus_v1.4.2.zip"; DestDir: "{code:GetShaderDir}"; Flags: ignoreversion
