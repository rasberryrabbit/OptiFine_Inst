...
#define JarName2 'OptiFine_1.18.2_HD_U_H6'
#define JarName3 'optifabric-1.13.5'
#define JarName4 'fabric-api-0.57.0+1.19'
#define JarName5 'Xaeros_Minimap_22.6.1_Fabric_1.18.2'
#define JarName6 'voicechat-fabric-1.18.2-2.2.31'
#define JarName7 'CocoaInput-1.18-fabric-4.0.4'
#define JarName8 'WindowedFullscreen-1.18-fabric-1.0.1'
#define JarName9 'sodium-fabric-mc1.18.2-0.4.1+build.15'
#define JarName10 'canvas-fabric-mc118-1.0.2308'
#define JarName11 'BetterF3-1.2.4-Fabric-1.18.2'
#define JarName12 'XaerosWorldMap_1.20.7_Fabric_1.18.2'
#define JarName13 'phosphor-fabric-mc1.18.x-0.8.1'
#define JarName14 'iris-mc1.18.2-1.2.2-build.32'
