...
#define JarName1 'Iris-Installer-3.0.1'
...
AppId={{77A60E61-81B6-4D65-8ACF-F10262894349}
AppName={#JarName1} Installer {#CurrDate}
AppVersion=0.1
;AppVerName=OptiFine Installer {#JarName2}
AppPublisher=anon
OutputBaseFilename={#JarName1}_{#CurrDate}
Compression=lzma2/max
SolidCompression=yes
Uninstallable=no
VersionInfoTextVersion={#JarName1}
...
begin
  Result:='{#JarName1} Installer {#CurrDate}'+#13#10;
  SMCDir:=MCDirCheck;
