...
#define JarName4 'fabric-api-0.83.1+1.20.1'
#define JarName5 'Xaeros_Minimap_23.4.4_Fabric_1.20'
#define JarName6 'voicechat-fabric-1.20.1-2.4.10'
#define JarName7 'CocoaInput-1.20.1-fabric-4.3.0-EXPERIMENTAL'

#define JarName11 'BetterF3-7.0.0-Fabric-1.20-pre6'
#define JarName18 'modmenu-7.1.0'
#define JarName12 'XaerosWorldMap_1.30.4_Fabric_1.20'
; performance
;#define JarName13 'phosphor-fabric-mc1.19.x-0.8.1'
#define JarName15 'starlight-1.1.2+fabric.dbc156f'
; memory leak fix
#define JarName10 'memoryleakfix-fabric-1.17+-1.1.1'
; iris shader
#define JarName9 'sodium-fabric-mc1.20-0.4.10+build.27'
;#define JarName16 'sodium-fabric-mc1.19.4-0.4.11+build.26-api'
#define JarName14 'iris-mc1.20-1.6.4'

#define MCVersion '1.20.1'
